...
----
    ...
    ** La bonne réponse est la "B" (plus de détails https://docs.microsoft.com/en-us/lifecycle/policies/modern#continuity-and-migration[ici]), et vous me dites si vous trouvez l'information là où elle aurait du être, à savoir là : https://docs.microsoft.com/en-us/learn/modules/choose-azure-services-sla-lifecycle/5-access-preview-services. +
